...
const { validationBodySertifikasi } = require('../middleware/validation');

router.get('/', sertifikasiController.getAllSertifikasi);
router.get('/:id', sertifikasiController.getSertifikasiById);
router.post('/', validationBodySertifikasi, sertifikasiController.createSertifikasi);
router.put('/:id', validationBodySertifikasi, sertifikasiController.updateSertifikasi);
